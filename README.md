...
1. Suffrage (NOTE: not to be confused with "universal suffrage"; these two are distinct concepts especially in the context of Hong Kong politics) in Hong Kong started in 1982 when the British colonial government introduced popularly-elected seats for the city's local administation bodies, namely, the Urban Council and the newly-established District Boards. However, this database only goes down to the 1994 District Boards elections as this is the earliest election year where shapefiles/pre-made SVGs of the electoral boundaries are available on the Internet.

2. This database omits the 1995, 1998 and 2000 Legislative Council (LegCo) elections due to a lack of granular election results (i.e. only the final results at the geographical constituency (GC) level was released), making these elections impossible to map by a level by polling place. Since Hong Kong was a British colony, this was consistent with the UK's practice of centralizing the vote counting process so that only the overall results of a parliamentary constituency were made available. This persisted until the 2004 LegCo elections when ballots were finally counted at the polling station level, even though the polling station boundaries do not necessarily follow DCCA boundaries (more on that later). 

That being said, all the elections you can find on this database are:
LegCo general elections: 2004, 2008, 2012, 2016
DB/DC general elections: 1994, 1999, 2003, 2007, 2011, 2015, 2019
UC/RC general election: 1995
LegCo by-elections: 2007 (HKI), 2010 (All GCs), 2016 (NTE), 201803 (HKI, KLW, NTE), 201811 (KLW)
